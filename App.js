    ...
    <View style={{width:'100%',borderWidth:2}}>
      <View style={styles.ROW}>
        <NumButton
          ...
          Field={{ getField: props.getField, changeField: props.changeField }}
          index={0}
        />
        <NumButton
          Player={{
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          if (
            ...
            checkWin[2] == checkWin[4] &&
            checkWin[2] == checkWin[6] &&
            checkWin[2] != ""
          ) {
            if (checkWin[2] == "O") {
            ...
            checkWin[0] == checkWin[3] &&
            checkWin[0] == checkWin[6] &&
            checkWin[0] != ""
          ) {
            if (checkWin[0] == "O") {
            ...
            checkWin[0] == checkWin[4] &&
            checkWin[0] == checkWin[8] &&
            checkWin[0] != ""
          ) {
            if (checkWin[0] == "O") {
            ...
            checkWin[1] == checkWin[4] &&
            checkWin[1] == checkWin[7] &&
            checkWin[1] != ""
          ) {
            if (checkWin[1] == "O") {
            ...
            checkWin[2] == checkWin[5] &&
            checkWin[2] == checkWin[8] &&
            checkWin[2] != ""
          ) {
            if (checkWin[2] == "O") {
            ...
            checkWin[3] == checkWin[4] &&
            checkWin[3] == checkWin[5] &&
            checkWin[3] != ""
          ) {
            if (checkWin[3] == "O") {
            ...
            checkWin[6] == checkWin[7] &&
            checkWin[6] == checkWin[8] &&
            checkWin[6] != ""
          ) {
            if (checkWin[6] == "O") {
